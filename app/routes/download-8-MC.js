...
router.all('/get-a-proof-of-benefit-letter/download/download-8-MC/research-set-up/PoB-clear-data', function (req, res) {
  ...
  router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/research-set-up/benefits-answer', function (req, res) {
  ...
  res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/research-set-up/address');

   })

   // Drop user if they were not invited to use the service
router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/how-did-you-find-out-about-this-service-answer', function (req, res) {
  ...
  if (howDidYouFindOutAboutThisService === "heard-about-on-phone" || howDidYouFindOutAboutThisService === "job-centre")  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/go-to-identity-check');

  } else {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/cannot-get-a-proof-of-benefit-letter');
  }
})

// Select which benefit selection page to show based on number of benefits available for user.
router.all('/get-a-proof-of-benefit-letter/download/download-8-MC/list-benefits-answer', function (req, res) {

  var researchSetUpBenefits = req.session.data['researchSetUpBenefits']

  if (researchSetUpBenefits == [] || researchSetUpBenefits == undefined)  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/you-cannot-use-this-service-no-benefits');
    return

  } else if ((researchSetUpBenefits.length > 0) && (inScope.length > 0 ))   {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/select-benefits-you-need-proof-of');

  } else if (inScope.length === 0 )  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/you-cannot-get-proof-of-benefit-letter');
...
router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/select-benefits-answer', function (req, res) {
 ...
 if (doYouWantLetterFor === 'no') 
    {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/contact-us-for-different-benefit-letter');
  }

  else {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/where-we-send-your-letter');
  }
...
router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/select-benefits-answer-change-link', function (req, res) {
  ...
  var doYouWantLetterFor = req.session.data['doYouWantLetterFor']
    ...
    if (doYouWantLetterFor === 'no') {
      ...
      res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/check-your-answers');
    }
...
router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/send-letter-to-address-answer', function (req, res) {
  ...
  if (altFormatType === 'Accessible PDF') 
{
    ...
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/digital-or-letter-accessible-pdf');
  }

  // Check if user selected no on single address page
  else if (confirmLetterSend == "No")  {
    // Send user to contact us page
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/you-cannot-use-this-service-incorrect-address');
  }

  else {
    // Send user to check answers
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/digital-or-letter');
  }
...
router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/change-link', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/download/download-8-MC/check-your-answers-answer', function (req, res) {

  var digitalOrLetter = req.session.data['digitalOrLetter']

  if (digitalOrLetter === 'Posted letter') {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-8-MC/request-complete');
...
router.get('/get-a-proof-of-benefit-letter/download/download-8-MC/research-set-up/alt-formats-list', function (req, res) {
  res.render('/get-a-proof-of-benefit-letter/download/download-8-MC/research-set-up/alt-formats-list', {
    altFormats: [
      "Audio recording",
      "Braille",
