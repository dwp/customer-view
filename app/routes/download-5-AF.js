...
router.all('/get-a-proof-of-benefit-letter/download/download-5-AF/research-set-up/PoB-clear-data', function (req, res) {
  ...
  router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/research-set-up/benefits-answer', function (req, res) {
  ...
  res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/research-set-up/address');

   })

   // Drop user if they were not invited to use the service
router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/how-did-you-find-out-about-this-service-answer', function (req, res) {
  ...
  if (howDidYouFindOutAboutThisService === "heard-about-on-phone" || howDidYouFindOutAboutThisService === "job-centre")  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/go-to-identity-check');

  } else {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/cannot-get-a-proof-of-benefit-letter');
  }
})

// Select which benefit selection page to show based on number of benefits available for user.
router.all('/get-a-proof-of-benefit-letter/download/download-5-AF/list-benefits-answer', function (req, res) {

  var researchSetUpBenefits = req.session.data['researchSetUpBenefits']

  if (researchSetUpBenefits == [] || researchSetUpBenefits == undefined)  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/you-cannot-use-this-service-no-benefits');
    return

  } else if ((researchSetUpBenefits.length > 0) && (inScope.length > 0 ))   {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/select-benefits-you-need-proof-of');

  } else if (inScope.length === 0 )  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/you-cannot-get-proof-of-benefit-letter');

  }

})

router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/select-benefits-answer', function (req, res) {

  var doYouWantLetterFor = req.session.data['doYouWantLetterFor']

    if (doYouWantLetterFor === 'no') {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/contact-us-for-different-benefit-letter');
    }

    else {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/where-we-send-your-letter');
    }

})

router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/select-benefits-answer-change-link', function (req, res) {
  ...
  var doYouWantLetterFor = req.session.data['doYouWantLetterFor']
    ...
    if (doYouWantLetterFor === 'no') {
      ...
      res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/check-your-answers');
    }
...
router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/send-letter-to-address-answer', function (req, res) {
  ...
  if (confirmLetterSend == "No")  {
    ...
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/you-cannot-use-this-service-incorrect-address');
  }

  else {
    // Send user to check answers
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/digital-or-letter');
  }
...
router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/change-link', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/download/download-5-AF/check-your-answers-answer', function (req, res) {

  var digitalOrLetter = req.session.data['digitalOrLetter']

  if (digitalOrLetter === 'Posted letter') {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-5-AF/request-complete');
